...
class InfoArea  {
  ...
  void display() {
    ...
    color c2 = color(230, 145, 28);

    pushMatrix();
    translate(loc.x, loc.y);

    makeInfoRect(xOffset, 0*yOffset+90, c1, c2, "Level");
    fill(255, 255, 0);
    text("Some Text", 40, yOffset);
    makeInfoRect(xOffset, 1*yOffset+90, c1, c2, "Score");
    fill(255, 255, 0);
    text("Some Text", 40, 2*yOffset);
    makeInfoRect(xOffset, 2*yOffset+90, c1, c2, "Lives");
    fill(255, 255, 0);
    text("Some Text", 40, 3*yOffset );
    makeInfoRect(xOffset, 3*yOffset+90, c1, c2, "Enemies");
    fill(255, 255, 0);
    text("Some Text", 40, 4*yOffset );
    makeInfoRect(xOffset, 4*yOffset+90, c1, c2, "Highest");
    fill(255, 255, 0);
